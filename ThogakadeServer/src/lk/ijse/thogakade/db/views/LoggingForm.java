 ...
 */
package lk.ijse.thogakade.db.views;
...
import lk.ijse.thogakade.server.StartServer;
...
public class LoggingForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Configure MySQL Connection");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            DBConnection.getInstance().setConnection(txtUserName.getText(), txtPassword.getText());
            
        } catch (SQLException ex) {
            Logger.getLogger(LoggingForm.class.getName()).log(Level.SEVERE, null, ex);
        }
