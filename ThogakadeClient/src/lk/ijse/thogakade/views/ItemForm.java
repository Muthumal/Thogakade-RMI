...
public class ItemForm extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        tblItem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Descriprion", "Qty On Hand", "Unit Price"
            }
        ) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (!state) {
            try {
                ...
                state = state && validateData(txtID.getText());
                if (!state) {
                    txtResult.setForeground(Color.blue);
                    txtResult.setText("Item is no longer in database...");
                    return;
                }
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            JasperReportViewer reportViewer = new JasperReportViewer(itemController.print());
    ...
    private boolean validateData(String id) {
        try {
            ItemDTO get = itemController.get(new ItemDTO(txtID.getText()));
            return get != null;
        } catch (Exception ex) {
            Logger.getLogger(CustomerForm.class.getName()).log(Level.SEVERE, null, ex);
        }
