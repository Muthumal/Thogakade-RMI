...
public class CustomerForm extends javax.swing.JFrame implements Observer {
    ...
    public CustomerForm() {
        ...
        try {
            ...
            customerController.registorObserver(this);
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jLayeredPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Customer Detail", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            CustomerDTO dTO = new CustomerDTO(
                    ...
                    txtName.getText(), 
                    txtAddress.getText(), 
                    new Double(txtSalary.getText())
            );
                    
            boolean add = customerController.add(dTO);
            customerController.release(txtID.getText());
            if (add) {
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        ...
        try {
            customerController.unRegistorObserver(this);
            dispose();
        } catch (Exception ex) {
            Logger.getLogger(CustomerForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(!state){
            try {
                state=customerController.reserve(txtID.getText());
                if(!state){
        ...
        try {
            ...
            boolean update = customerController.update(dTO);
            customerController.release(id);
            state=false;
            if (update) {
                txtResult.setForeground(Color.green);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            boolean delete = customerController.delete(dTO);
            customerController.release(id);
            state=false;
            clear();
            if (delete) {
...
DefaultTableModel dtm=(DefaultTableModel) tblCustomer.getModel();
    if(tblCustomer.getSelectedRow()!=-1){
        ...
        txtAddress.setText((String)dtm.getValueAt(i, 2));
        txtSalary.setText(String.valueOf(dtm.getValueAt(i, 3)));
    try {
        state=customerController.reserve(txtID.getText());
    } catch (RemoteException ex) {
        Logger.getLogger(CustomerForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txtIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIDActionPerformed
        try {
            ...
            dto = customerController.get(dto);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try {
            JasperReportViewer reportViewer = new JasperReportViewer(customerController.print());
...
//            JasperPrint filledreport = JasperFillManager.fillReport(jasperreport, new HashMap<>(), new JRTableModelDataSource(tblCustomer.getModel()));
//
...
//        }
    ...
    public void loadTable() {
        try {
            ...
            for (CustomerDTO t : all) {
                Object[] row = {t.getId(),t.getName(),t.getAddress(),t.getSalary()};
                dtm.addRow(row);
            }
        } catch (Exception ex) {
            Logger.getLogger(CustomerForm.class.getName()).log(Level.SEVERE, null, ex);
